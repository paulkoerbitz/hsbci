...
elemToMSGTests =
  [ testGroup "MSG Tests"
    ...
    , testCase "MSGdef with SF containing two SEGs and a SEG and values" $
      ...
      in assertEq (Just ("msg01", MSG True True [SF 1 Nothing [SEG "SegInSf" False
                  ...
                  msgItems = [SF {sfMinNum = 1,
                                  ...
                                  sfItems = [SEG {segName = "MsgHead",
                                                  ...
                                                  segItems = [DEGItem (DEG {degName = "SegHead",
                                                             ...
                                                             ,DEGItem (DEG {degName = "", degMinNum = 0, degMaxNum = Just 1, degItems = [DEval (DEStr "0"),DEval (DEStr "1")]})]}]}
                             ,SF {sfMinNum = 1,
                                  sfMaxNum = Just 1,
                                  sfItems = [SEG {segName = "",
                                                  needsRequestTag = False,
                                                  segItems = [DEGItem (DEG {degName = "SegHead",
                                                             ...
                                                             ,DEItem (DEdef {deName = "customerid", deType = ID, deMinSize = 0, deMaxSize = Nothing, deMinNum = 1, deMaxNum = Nothing, deValids = Nothing})
                                                             ,DEItem (DEdef {deName = "sysid", deType = ID, deMinSize = 0, deMaxSize = Nothing, deMinNum = 1, deMaxNum = Nothing, deValids = Nothing})
                                                             ,DEItem (DEdef {deName = "sysStatus", deType = Num, deMinSize = 0, deMaxSize = Just 1, deMinNum = 1, deMaxNum = Nothing, deValids = Just ["0","1"]})]}]}
                             ,SF {sfMinNum = 1,
                                  sfMaxNum = Just 1,
                                  sfItems = [SEG {segName = "",
                                                  needsRequestTag = False,
